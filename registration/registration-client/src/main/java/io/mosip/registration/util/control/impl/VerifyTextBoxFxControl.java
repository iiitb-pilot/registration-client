...
public class VerifyTextBoxFxControl extends TextFieldFxControl {
    ...
    public FxControl build(UiFieldDTO uiFieldDTO) {
        ...
        verifyButton.setOnAction(event -> {
            ...
            String nationalId = getFieldValue(secondaryFieldId);

            LOGGER.debug("Verification inputs -> phone={}, nationalId={}", phone, nationalId);
            ...
            Task<Boolean> verificationTask = new Task<>() {
                ...
                protected Boolean call() {
                    ...
                    return mobileVerificationService.verify(nationalId, phone);
                }
            };
