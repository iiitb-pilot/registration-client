...
public class RegistrationUIConstants {
	...
	public static final String UNSUPPORTED_PRE_MESSAGE="ERROR_PRE_UNSUPPORTED_VERSION";
	public static final String UNSUPPORTED_POST_MESSAGE="ERROR_POST_UNSUPPORTED_VERSION";
	public static final String DEVICE_SETTING_UNSUPPORTED_VERSION_MESSAGE="ERROR_DEVICE_SETTING_UNSUPPORTED_VERSION";
	public static final String ATTENTION_MESSAGE="ERROR_ATTENTION_MESSAGE";
	public static final String RERUN="ERROR_RERUN_MESSAGE";
}
