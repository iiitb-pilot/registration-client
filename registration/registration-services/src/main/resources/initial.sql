...
CREATE TABLE "REG"."USER_DETAIL" ("ID" VARCHAR(100) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "EMAIL" VARCHAR(64), "MOBILE" VARCHAR(16), "STATUS_CODE" VARCHAR(64), "LANG_CODE" VARCHAR(3) NOT NULL, "LAST_LOGIN_DTIMES" TIMESTAMP, "LAST_LOGIN_METHOD" VARCHAR(36), "UNSUCCESSFUL_LOGIN_COUNT" SMALLINT, "USERLOCK_TILL_DTIMES" TIMESTAMP, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "REG_ID" VARCHAR(36), "SALT" VARCHAR(64), "REG_CNTR_ID" VARCHAR(10) NOT NULL);
...
CREATE TABLE "REG"."REG_CENTER_USER_MACHINE" ("REGCNTR_ID" VARCHAR(10) NOT NULL, "USR_ID" VARCHAR(100) NOT NULL, "MACHINE_ID" VARCHAR(10) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."USER_ROLE" ("USR_ID" VARCHAR(100) NOT NULL, "ROLE_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."USER_TOKEN" ("USR_ID" VARCHAR(100) NOT NULL, "TOKEN" VARCHAR(2048), "TOKEN_EXPIRY" BIGINT, "REFRESH_TOKEN" VARCHAR(2048), "RTOKEN_EXPIRY" BIGINT, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP);
